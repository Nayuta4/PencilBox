...
public class Board extends BoardBase {
	...
	static final String ERR_WRONG_NUMBER = "橋が数が数字と一致していない";
//	static final String ERR_TOO_MANY_LINE = "橋が数が多すぎる数字がある";
//	static final String YET_TOO_FEW_LINE= "橋が足りない数字がある";
