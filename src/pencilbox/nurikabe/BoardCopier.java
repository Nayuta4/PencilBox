...
public class BoardCopier extends BoardCopierBase {
	...
	public void copyRegion(BoardBase srcBoardBase, BoardBase ｂoardBase, pencilbox.common.core.AreaBase region, Address from, Address to, int rotation) {
		Board srcBoard = (Board) srcBoardBase;
		Board board = (Board) ｂoardBase;
