...
public class ResourceBundle extends ListResourceBundle {
    ...
    { "MenuBase.rotationMenu"                       , "Rotation"                                                   } ,
    ...
    { "MenuBase.rotationItem1"                      , "Rotate 90 Degrees to Left"                                  } ,
    { "MenuBase.rotationItem2"                      , "Rotate 180 Degrees"                                         } ,
    { "MenuBase.rotationItem3"                      , "Rotate 90 Degrees to Right"                                 } ,
    { "MenuBase.rotationItem4"                      , "Exchange Horizontal and Vertical"                           } ,
    { "MenuBase.rotationItem5"                      , "Reverse Left and Right"                                     } ,
    { "MenuBase.rotationItem6"                      , "Rotate 180 Degrees and Exchange Horizontal and Vertical"    } ,
    { "MenuBase.rotationItem7"                      , "Reverse Up and Down"                                        } ,
